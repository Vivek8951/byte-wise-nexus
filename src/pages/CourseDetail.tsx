...
export default function CourseDetail() {
  ...
  }, [id, getCourse, getCourseVideos, getCourseNotes]);
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  {videos.map((video, index) => (
                    <Card 
                      key={video.id} 
                      className={`flex items-center gap-4 p-4 rounded-md border cursor-pointer hover:bg-secondary ${activeVideo?.id === video.id ? 'bg-secondary text-secondary-foreground' : ''}`}
